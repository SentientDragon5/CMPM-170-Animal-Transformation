...
public class CrabController : GenericMoveController
{
    ...
    public override void Move(Vector3 moveInput)
    {
        ...
        Vector3 groundMovement = new Vector3(moveInput.x, 0, 0);
    ...
    private void RotateWithCamera()
    {
        ...
        // Get camera forward direction (ignore Y axis for horizontal rotation)
        ...
        {
            // Create target rotation based on camera direction
